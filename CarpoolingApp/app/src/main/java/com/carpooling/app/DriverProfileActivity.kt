...
import com.carpooling.app.databinding.ActivityDriverProfileBinding
...
class DriverProfileActivity : AppCompatActivity() {
    ...
    companion object {
        private const val TAG = "DriverProfileActivity"
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvReviews.apply {
            layoutManager = LinearLayoutManager(this@DriverProfileActivity)
    ...
    private fun loadDriverProfile() {
        ...
        lifecycleScope.launch {
            try {
                ...
                // Load average rating
                val ratingResponse = RetrofitClient.apiService.getAverageRating(driverId)
                Log.d(TAG, "Rating response: ${ratingResponse.isSuccessful}")

                // Load reviews as driver
